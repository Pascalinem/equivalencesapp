        ...
        <table class="table-auto">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> 
                        @if($item->demande_id)
                    <span class=" py-4 px-8 mx-2 bg-green-200"> Demande en cours</span>
                        @else
                        <button  href='#liste-etudes' class="bg-white hover:bg-green-400 text-gray-800 font-semibold mb-4 mt-8 py-4 px-4 border border-gray-400 rounded shadow" wire:click="creerDemande({{ $item->id}})">Introduire une demande</button>
                        @endif 
                    </td>
                </tr>
